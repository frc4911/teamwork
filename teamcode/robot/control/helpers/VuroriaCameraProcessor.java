...
/**
 * Created by thomp on 11/3/2017.
 */

public class VuroriaCameraProcessor {
    ...
    public String formatPictographId() {
        RelicRecoveryVuMark vuMark = identifyPictograph();
        String msg = "VuMark: not visible";
        if (vuMark != RelicRecoveryVuMark.UNKNOWN) {
            msg = "VuMark: " + vuMark + " visible";
        }
        return msg;
    }
